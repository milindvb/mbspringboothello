Deploy Java Spring Boot App to Azure Webapp for Containers using JIB (Java Image Builder) {#deploy-java-spring-boot-app-to-azure-webapp-for-containers-using-jib-java-image-builder .ListParagraph}
=========================================================================================
