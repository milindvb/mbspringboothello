...
Edit pom.xml and change the following:

<!-- Web App information -->
<resourceGroup>myspringbootresgrp</resourceGroup>  <--- Change to your resource group
<appName>myspringbootlinux2</appName>  <-- new or existing app name
<region>centralus</region>
Save pom.xml and build using “mvn clean package”
...
[INFO] Final Memory: 36M/175M
[INFO] ------------------------------------------------------------------------
Push to azure using “mvn azure-webapp:deploy”
$ mvn azure-webapp:deploy
[INFO] Scanning for projects...
[INFO]
[INFO] ------------------------------------------------------------------------
...
[INFO] Final Memory: 45M/206M
[INFO] ------------------------------------------------------------------------
Browse the app using the url:
https://myspringbootlinux2.azurewebsites.net/hello?text=world

For the PublishController code, please check the file
...
Markdown 4806 bytes 435 words 113 lines Ln 105, Col 3HTML 4209 characters 418 words 94 paragraphs
